...
void setuppos() {
  ...
  nsorigin = new PVector (300, -50, -800);
  nssize = new PVector(400, 400, 600);
  rsorigin = new PVector(width-115, 85*4.5);
  rssize = new PVector(100, 100);
  rsorigin2 = new PVector(width-115, 85*9);
  rssize2 = new PVector(100, 100);
  mapscale = 0.40;
  nndrorigin = new PVector(width-250, 30*2);
  nnl1origin = new PVector (450, 240);
  nnl2origin = new PVector (450, 430);
  nnl3origin = new PVector (450, 485);
}
void setupvar() {
  gang = 75;
  yang = 75;
